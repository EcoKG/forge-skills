...
├── forge/                  # Forge v2.1 — Context-Engineered Autonomous Dev System
...
L2: Self-Check (Implementation) — 6-item checklist, analysis paralysis guard
...
| 디렉토리 | 설명 |
|---|---|
| `forge/` | Forge v2.1 — 컨텍스트 엔지니어링 기반 자율 개발 시스템 |
...
L2: Self-Check (구현)    — 6항목 체크리스트, analysis paralysis guard
